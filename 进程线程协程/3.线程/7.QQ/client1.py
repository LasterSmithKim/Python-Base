...
button = tkinter.Button(win,text = "连接",command = connectServer,width = 10,height =10).grid(row=3,column=0)
...
button2 = tkinter.Button(win,text = "发送",command = sendMail,width = 10,height =10).grid(row=7,column=0)
